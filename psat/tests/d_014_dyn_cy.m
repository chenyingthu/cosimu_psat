...
Shunt.con = [ ...
   9 100        13.8 60        0     0.19 1;
   ];

Line.con = [ ...
   1    2 100        69 60 0         0  0.01938  0.05917   0.0528        0        0       99        0        0  1;
   1    5 100        69 60 0         0  0.05403    0.223   0.0492        0        0       99        0        0  1;
   2    3 100        69 60 0         0  0.04699    0.198   0.0438        0        0       99        0        0  1;
   2    4 100        69 60 0         0  0.05811   0.1763    0.034        0        0       99        0        0  1;
   2    5 100        69 60 0         0  0.05695   0.1739   0.0346        0        0       99        0        0  1;
   3    4 100        69 60 0         0  0.06701    0.171   0.0128        0        0       99        0        0  1;
   4    5 100        69 60 0         0  0.01335  0.04211        0        0        0       99        0        0  1;
   4    7 100        69 60 0         5        0   0.2091        0    0.978        0       99        0        0  1;
   4    9 100        69 60 0         5        0   0.5562        0    0.969        0       99        0        0  1;
   5    6 100        69 60 0         5       0    0.252        0    0.932        0       99        0        0  1;
   6   11 100        13.8 60 0         0  0.09498   0.1989        0        0        0       99        0        0  1;
   6   12 100        13.8 60 0         0   0.1229   0.2558        0        0        0       99        0        0  1;
   6   13 100        13.8 60 0         0  0.06615   0.1303        0        0        0       99        0        0  1;
   7    8 100        13.8 60 0         0        0   0.1762        0        0        0       99        0        0  1;
   7    9 100        13.8 60 0         0        0     0.11        0        0        0       99        0        0  1;
   9   10 100        13.8 60 0         0  0.03181   0.0845        0        0        0       99        0        0  1;
   9   14 100        13.8 60 0         0   0.1271   0.2704        0        0        0       99        0        0  1;
  10   11 100        13.8 60 0         0  0.08205   0.1921        0        0        0       99        0        0  1;
  12   13 100        13.8 60 0         0   0.2209   0.1999        0        0        0       99        0        0  1;
  13   14 100        13.8 60 0         0   0.1709    0.348        0        0        0       99        0        0  1;
   ];
