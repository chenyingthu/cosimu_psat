  ...
  case 'aboutdown'
    ...
    for i = 1:length(h)
      ...
      if pos(1) > ph1 && pos(2) > ph2  && pos(1) < ph3 && pos(2) < ph4
        switch i
        case 1, web('mailto:Federico.Milano@uclm.es');
        case 2, web('http://www3.uclm.es/profesorado/federico.milano/');
...
h1 = uicontrol('Parent',h0, ...
  ...
  'String','(c) 2002-2013 Federico Milano', ...
  'Style','text', ...
  'Tag','StaticText3');
%h1 = uicontrol('Parent',h0, ...
%               'Units', 'normalized', ...
...
h(1) = uicontrol('Parent',h0, ...
  ...
  'String','Federico.Milano@uclm.es', ...
  'Style','text', ...
  'Tag','StaticText3');
...
h(2) = uicontrol('Parent',h0, ...
  ...
  'String','http://www3.uclm.es/profesorado/federico.milano/', ...
  'Style','text', ...
  'Tag','StaticText2');
