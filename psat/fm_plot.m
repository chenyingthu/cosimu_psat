...
global DAE Bus Syn Settings Fig Snapshot Hdl CPF
...
switch flag
 ...
 case 'plotvars'
  ...
  if ~OPF.init
    ...
    for i = 1:length(Value)
      ...
      if isdelta(Syn,kk) || isdelta(Mass,kk) || isdelta(SSR,kk) ...
          || isdelta(Pmu,kk)
        Y(:,i) = Y(:,i) - angolo;
  ...
  fm_plot plotvlims
  fm_plot plotslims
  set(hdlfig,'Position',[0.09 0.4050 0.4754 0.5000])
 ...
 case 'axesy'
  ...
  if Fig.line, fm_plot('createlinelist'), end
